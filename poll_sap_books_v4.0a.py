...
dir_book = "C:\\Users\\itqiuw\\Desktop\\gw100"         # notice "\\"
#dir_book = "C:\\Users\\Administrator\\Desktop\\tadmd1"

pa_name = "GW100_EN_Col20 SAP Gateway - Building OData Services" + ".pdf"
...
##    ClickPng(print_button)        # Click Print Button
    time.sleep(1)
    pyautogui.click(3168-1360, 87)       # Click Print Button
    ClickPng(save)
    tmptime = 0
